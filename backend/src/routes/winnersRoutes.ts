 ...
 *           items:
 *             type: string
 *           description: Lista de erros específicos
 ...
 *     description: Implementa uma rota específica /ganhadores/agregacao que retorno o total de ganhadores por estado (UF), alimentando o mapa interativo no frontend com dados otimizados.
 *     responses:
 *       200:
